...
% zuletzt überarbeitet von: Pascal Heßler  am 17.10.2025
% ------------------------------------------------------------------------
...
\include{sections/titel}              % Titelseite einbinden
...
% \prettyresult                        % now in it own chapter
